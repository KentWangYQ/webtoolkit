...
{
    public abstract class OpenAuthClientBase
    {
        #region Property
        ...
        #region Init
        public OpenAuthClientBase(string clientId, string clientSecret, string callbackUrl, string accessToken = null)
        {
        ...
        public abstract void GetAccessTokenByCode(string code, string state);
        public abstract void GetOpenId();
        #endregion
